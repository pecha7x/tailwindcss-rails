...
if APPLICATION_LAYOUT_PATH.exist?
  ...
  insert_into_file APPLICATION_LAYOUT_PATH.to_s, <<~ERB.indent(4), before: /^\s*<%= stylesheet_link_tag/
    <%= stylesheet_link_tag "tailwind-application", "inter-font", "data-turbo-track": "reload" %>
  ERB
  ...
  say %(        Add <%= stylesheet_link_tag "tailwind-application", "inter-font", "data-turbo-track": "reload" %> within the <head> tag in your custom layout.)
end
...
unless Rails.root.join("config/tailwind.config.js").exist?
  say "Add default config/tailwindcss/application.config.js"
  empty_directory "config/tailwindcss"
  copy_file "#{__dir__}/tailwind.config.js", "config/tailwindcss/application.config.js"
end
